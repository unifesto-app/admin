    ...
    try {
      ...
      if (response.ok) {
        ...
        setFormData({
          ...
          banner_url: data.organization.banner_url || '',
          ...
          is_verified: data.organization.is_verified,
          is_active: data.organization.is_active,
        });
      } else {
        console.error('Error fetching organization:', data.error);
        // If organization not found, redirect to listing page
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              {organization.parent_org && (
                <div>
                  ...
                  <input
                    type="text"
                    value={organization.parent_org.name}
                    disabled
